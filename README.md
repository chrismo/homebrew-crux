...
Homebrew tap for [**crux**](https://github.com/chrismo/crux) — a local TUI
...
[crux release workflow](https://github.com/chrismo/crux/blob/main/.github/workflows/release.yml)
